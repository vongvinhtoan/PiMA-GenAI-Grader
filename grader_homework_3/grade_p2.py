...
def plot_function_conture():
    ...
    plt.title("Biểu đồ nhiệt hàm $f(x, y)$")
    plt.xlabel("$x$")
    plt.ylabel("$y$")
    plt.grid(True)
    plt.axis("equal")
...
def test_function_contour(f_tested):
    ...
    ax1.set_title("Biểu đồ nhiệt hàm $f_{tested}(x, y)$")
    ax1.set_xlabel("$x$")
    ax1.set_ylabel("$y$")
    ax1.grid(True)
    ax1.axis("equal")
    ...
    ax2.set_title("Biểu đồ nhiệt hàm $f_{jury}(x, y)$")
    ax2.set_xlabel("$x$")
    ax2.set_ylabel("$y$")
    ax2.grid(True)
    ax2.axis("equal")
...
def test_function_derivative_vector_field(grad_f):
    ...
    ax2.set_title("Trường vector của $\\nabla f(x, y)$ với overlay kết quả")
    ax2.set_xlabel("$x$")
    ax2.set_ylabel("$y$")
    ax2.axis("equal")
    ax2.grid(True)
