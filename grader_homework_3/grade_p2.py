...
def plot_function_conture():
    ...
    cbar.set_label('Giá trị của hàm $f(\\bf{x})$')
    plt.title("Biểu đồ nhiệt hàm $f(\\bf{x})$")
    plt.xlabel("$x$")
    plt.ylabel("$y$")
    plt.grid(True)
    plt.axis("equal")
...
def plot_function_derivative_vector_field():
    ...
    ax2.set_title("Trường vector của $\\nabla f(\\bf{x})$ + Đường đồng mức của $f(\\bf{x})$")
    ax2.set_xlabel("$x$")
    ax2.set_ylabel("$y$")
    ax2.axis("equal")
    ax2.grid(True)
...
def test_function_contour(f_tested):
    ...
    cbar1.set_label('Giá trị của hàm $f_{tested}(\\bf{x})$')
    ax1.set_title("Biểu đồ nhiệt hàm $f_{tested}(\\bf{x})$")
    ax1.set_xlabel("$x$")
    ax1.set_ylabel("$y$")
    ax1.grid(True)
    ax1.axis("equal")
    ...
    cbar2.set_label('Giá trị của hàm $f_{jury}(\\bf{x})$')
    ax2.set_title("Biểu đồ nhiệt hàm $f_{jury}(\\bf{x})$")
    ax2.set_xlabel("$x$")
    ax2.set_ylabel("$y$")
    ax2.grid(True)
    ax2.axis("equal")
...
def test_function_derivative_vector_field(grad_f):
    ...
    ax2.set_title("Trường vector của $\\nabla f(\\bf{x})$ với overlay kết quả")
    ax2.set_xlabel("$x$")
    ax2.set_ylabel("$y$")
    ax2.axis("equal")
    ax2.grid(True)
